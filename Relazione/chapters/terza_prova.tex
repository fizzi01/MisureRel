...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{media/circuitoIntegrato_uA741.png}
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{FREQ [Hz]} & \textbf{V_i(mV)} & \textbf{KV_i(mV)} & \textbf{V_o(mV)} & \textbf{KV_o(mV)} & \textbf{A} \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{FREQ [Hz]} & \textbf{V_i(mV)} & \textbf{KV_i(mV)} & \textbf{U(V_i)} & \textbf{U_r(V_i)}  \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{FREQ [Hz]} & \textbf{V_o(mV)} & \textbf{KV_o(mV)} & \textbf{U(V_o)} & \textbf{U_r(V_o)}  \\ \hline
...
\begin{table}[!ht]
    ...
    \hline
        ...
        \textbf{FREQ [Hz]} & \textbf{A} & \textbf{U(A)} & \textbf{U_r(A)} & \textbf{U(A_{dB})} & \textbf{U_r(A_{dB})} & \textbf{A_{dB}}  \\ \hline
