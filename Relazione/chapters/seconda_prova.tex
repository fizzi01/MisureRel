...
\subsection{Diagrammi di Bode di modulo e fase}
Nelle figure ~\ref{fig:amplitude} e \ref{fig:phase} è possibile vedere graficati i valori di A\textsubscript{dB} e $\Delta\varphi$ rispetto alle frequenze in scala logaritmica, ossia i diagrammi di Bode di modulo e fase. 
