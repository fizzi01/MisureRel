...
\resizebox{\textwidth}{!}{%
    ...
    \hline
        \textbf{R letto [$\bm{\Omega}$]} & \textbf{R di Cortocircuito [$\bm{\Omega}$]} & \textbf{R [$\bm{\Omega}$]} & \textbf{Fondo scala} $\bm{[\Omega]}$ & \textbf{Q} $\bm{[\Omega]}$ & $\bm{U_q\ \ [\Omega]}$ & $\bm{U_R}$ \textbf{[$\bm{\Omega}$]} \\ \hline
