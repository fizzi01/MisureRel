...
\begin{figure}[h]
    \centering
    \includegraphics[height=5cm]{incertezza_port.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=10cm]{tabella_mult_banco.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[height=6cm]{Relazione/media/LCR_meter.png}
    \label{fig:LCR_meter}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=2cm]{Relazione/media/pannello_frontale_LCR.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=2cm]{Relazione/media/grafico_modulo.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[height=2cm]{Relazione/media/grafico_fase.png}
...
\begin{figure}[H]
    \centering
    \includegraphics{Relazione/media/diagramma_conversione_Cp.png}
